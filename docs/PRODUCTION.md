...
- **Command**: `python main.py dashboard --host 0.0.0.0 --port 8787 --traces-dir /tmp/traces` for free-tier managed platforms. (Ephemeral data; traces reset on restarts/redeploys.)
